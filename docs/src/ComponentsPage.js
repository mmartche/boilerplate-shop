            ...
            <div className="row">
              <div className="col-md-9" role="main">
                ...
                <div className="bs-docs-section">
                  ...
                  <div className="bs-callout bs-callout-warning">
                    ...
                    <p>Because React doesnt output newlines between elements, buttons on the same line are displayed
                ...
                <div className="bs-docs-section">
                  ...
                  <p>
                    If the default handling of the dropdown menu and toggle components arent to your liking, you can
              ...
              {/* Panels */}
                ...
                <div className="bs-docs-section">
                  ...
                  <p>Add a <code>label</code> prop to show a visible percentage. For low percentages, consider adding a min-width to ensure the labels text is fully visible.</p>
                ...
                <div className="bs-docs-section">
                  ...
                  <p>You dont need to include <code>frameborder="0"</code> in your <code>iframe</code>s.</p>
                ...
                <div className="bs-docs-section">
                  ...
                  The helper method <code>getInputDOMNode()</code> returns the internal input element. If you dont want the <code>form-group</code> class applied apply the prop named <code>standalone</code>.</p>
